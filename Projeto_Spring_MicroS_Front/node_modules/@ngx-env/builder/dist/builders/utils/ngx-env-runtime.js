...
exports.writeRuntimeFile = writeRuntimeFile;
const fs_1 = require("fs");
function writeRuntimeFile(browserOutputDir, serverOutputDir, locales = [], raw) {
    ...
    if (locales.length > 0) {
        locales.forEach((locale) => {
            ...
            try {
                ...
                console.log(`❌ Failed to create ngx-env.js at ${browserOutputDir}/${locale}/ngx-env.js ❌`);
                throw e;
            }
        });
    }
        ...
        try {
            ...
            console.log(`❌ Failed to create ngx-env.js at ${browserOutputDir}/ngx-env.js ❌`);
            throw e;
        }
        if (serverOutputDir) {
            try {
                console.log(`📦 Writing ngx-env.js to ${serverOutputDir}/ngx-env.js`);
                (0, fs_1.writeFileSync)(`${serverOutputDir}/ngx-env.js`, runtimeStmt);
            }
            catch (e) {
                console.log(`❌ Failed to create ngx-env.js at ${serverOutputDir}/ngx-env.js ❌`);
                throw e;
            }
        }
    }
}
//# sourceMappingURL=ngx-env-runtime.js.map